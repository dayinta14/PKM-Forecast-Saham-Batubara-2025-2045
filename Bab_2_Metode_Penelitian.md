...
| :--- | :--- | :--- | :--- | :--- |
| **ADRO** | PT Adaro Energy Indonesia Tbk | 2004 – 2024 | Harian (*Daily*) | Yahoo Finance API (`yfinance`) |
| **PTBA** | PT Bukit Asam Tbk | 2004 – 2024 | Harian (*Daily*) | Yahoo Finance API (`yfinance`) |
| **INDY** | PT Indika Energy Tbk | 2004 – 2024 | Harian (*Daily*) | Yahoo Finance API (`yfinance`) |
| **ITMG** | PT Indo Tambangraya Megah Tbk | 2004 – 2024 | Harian (*Daily*) | Yahoo Finance API (`yfinance`) |
